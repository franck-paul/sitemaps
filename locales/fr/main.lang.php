...
L10n::$locales['Failure'] = 'Échec';
L10n::$locales['Ping(s) sent'] = 'Ping(s) envoyé(s)';
...
L10n::$locales['Save preferences'] = 'Enregistrer les préférences';
L10n::$locales['Ping search engines'] = 'Notifier les moteurs de recherche';
L10n::$locales['Search engines notification'] = 'Notification des moteurs de recherche';
L10n::$locales['Available search engines'] = 'Moteurs de recherche disponibles';
